...
/**
 * 由于MultipartFormEntity有大小限制，自定义builder
 * @author wendy512
 * @date 2022-04-23 13:47:13:47
 * @since 1.0.0
 */
public class MultipartEntityExtBuilder extends MultipartEntityBuilder {
    /**
    ...
    public static MultipartEntityExtBuilder create() {
        return new MultipartEntityExtBuilder();
    }

    MultipartEntityExtBuilder() {
    }
    ...
    MultipartFormEntity buildEntity() {
        ...
        return new MultipartFormExtEntity(form, contentTypeCopy, form.getTotalLength());
    }
